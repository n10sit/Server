...
public class Config {
	...
	public static final String SERVER_NAME = "Exion";
	public static final String WELCOME_MESSAGE = "Exion";
	public static final String FORUMS = "Coming soon!";
	...
	public static final int START_LOCATION_X = 3368; // start here
	public static final int START_LOCATION_Y = 3279;
	public static final int RESPAWN_X = 3368; // when dead respawn here
	public static final int RESPAWN_Y = 3279;
	...
	public static final int MELEE_EXP_RATE = 100; // damage * exp rate
	...
	public static final int NPC_RANDOM_WALK_DISTANCE = 2; // the square created , 3x3 so npc can't move out of that box when randomly walking
