		...
		while(EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					...
					} else if (token.equals("character-pkills")) {
						p.playerKills = Double.parseDouble(token2);
					} else if (token.equals("character-pdeathss")) {
						p.playerDeaths = Double.parseDouble(token2);
					} else if (token.equals("character-nkills")) {
						p.npcKills = Double.parseDouble(token2);
					} else if (token.equals("character-ndeaths")) {
						p.npcDeaths = Double.parseDouble(token2);
					} else if (token.equals("character-pstreak")) {
						p.playerStreak = Integer.parseInt(token2);
					} else if (token.equals("character-nstreak")) {
						p.npcStreak = Integer.parseInt(token2);
					} else if (token.equals("character-points")) {
						p.points = Integer.parseInt(token2);
					} else if (token.equals("character-seed")) {
						p.currentSeed = Integer.parseInt(token2);
					} else if (token.equals("character-class")) {
						p.chosenClass = Boolean.parseBoolean(token2);
					} else if (token.equals("character-npcrank")) {
						p.npcRank = Integer.parseInt(token2);
					} else if (token.equals("character-pvprank")) {
						p.pvpRank = Integer.parseInt(token2);
					} else if (token.equals("character-betsmade")) {
						p.betsMade = Integer.parseInt(token2);
					} else if (token.equals("character-killsbeforebet")) {
						p.killsBeforeBet = Integer.parseInt(token2);
	...
	**/
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("character-pkills = ", 0, 19);
			characterfile.write(Double.toString(p.playerKills), 0, Double.toString(p.playerKills).length());
			characterfile.newLine();
			characterfile.write("character-pdeaths = ", 0, 20);
			characterfile.write(Double.toString(p.playerDeaths), 0, Double.toString(p.playerDeaths).length());
			characterfile.newLine();
			characterfile.write("character-nkills = ", 0, 19);
			characterfile.write(Double.toString(p.npcKills), 0, Double.toString(p.npcKills).length());
			characterfile.newLine();
			characterfile.write("character-ndeaths = ", 0, 20);
			characterfile.write(Double.toString(p.npcDeaths), 0, Double.toString(p.npcDeaths).length());
			characterfile.newLine();
			characterfile.write("character-pstreak = ", 0, 20);
			characterfile.write(Integer.toString(p.playerStreak), 0, Integer.toString(p.playerStreak).length());
			characterfile.newLine();
			characterfile.write("character-nstreak = ", 0, 20);
			characterfile.write(Integer.toString(p.npcStreak), 0, Integer.toString(p.npcStreak).length());
			characterfile.newLine();
			characterfile.write("character-points = ", 0, 19);
			characterfile.write(Integer.toString(p.points), 0, Integer.toString(p.points).length());
			characterfile.newLine();
			characterfile.write("character-seed = ", 0, 17);
			characterfile.write(Integer.toString(p.currentSeed), 0, Integer.toString(p.currentSeed).length());
			characterfile.newLine();
			characterfile.write("character-class = ", 0, 18);
			characterfile.write(Boolean.toString(p.chosenClass), 0, Boolean.toString(p.chosenClass).length());
			characterfile.newLine();
			characterfile.write("character-npcrank = ", 0, 20);
			characterfile.write(Integer.toString(p.npcRank), 0, Integer.toString(p.npcRank).length());
			characterfile.newLine();
			characterfile.write("character-pvprank = ", 0, 20);
			characterfile.write(Integer.toString(p.pvpRank), 0, Integer.toString(p.pvpRank).length());
			characterfile.newLine();
			characterfile.write("character-betsmade = ", 0, 21);
			characterfile.write(Integer.toString(p.betsMade), 0, Integer.toString(p.betsMade).length());
			characterfile.newLine();
			characterfile.write("character-killsbeforebet = ", 0, 27);
			characterfile.write(Integer.toString(p.killsBeforeBet), 0, Integer.toString(p.killsBeforeBet).length());
			characterfile.newLine();
