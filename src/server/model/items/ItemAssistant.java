...
public class ItemAssistant {
	...
	**/
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		} else if (WeaponName2.startsWith("dagger") || WeaponName2.contains("sword") || WeaponName2.contains("rapier")) {
		...
		} else if (WeaponName2.toLowerCase().contains("maul") || WeaponName2.toLowerCase().endsWith("-om") || WeaponName2.toLowerCase().contains("hammer")) {
	...
	**/
	...
	public void getRequirements(String itemName, int itemId) {
		...
		if (itemName.contains("rogue")) {
			c.attackLevelReq = 50;
			c.defenceLevelReq = 40;
		}
		if (itemName.contains("3rd age")) {
			if (itemId >= 10330 && itemId <= 10336) { //range
				c.defenceLevelReq = 80;
				c.rangeLevelReq = 80;
			} else if (itemId >= 10338 && itemId <= 10342) { //mage
				c.defenceLevelReq = 80;
				c.magicLevelReq = 80;
			} else if (itemId >= 10346 && itemId <= 10352) { //melee
				c.defenceLevelReq = 80;
			}
			c.prayerLevelReq = 80;
		}
	...
	public boolean wearItem(int wearID, int slot) {
		synchronized(c) {
			...
			if(c.playerItems[slot] == (wearID+1)) {				
				...
				if (wearID == 6330) { //snakeskin vamb
					targetSlot = 9;
				}
				if (wearID == 13861 || wearID == 13873 || wearID == 13890 || wearID == 13893) { //pvp legs
					targetSlot = 7;
				}
