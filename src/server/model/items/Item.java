...
public class Item {
  ...
  public static int randomgamble[] = {1050, 4151, 1038, 1040, 1042, 1044, 1046, 1048, 1419, 1053, 1055, 1057, 1961, 1959};
  public static int randomgamble() {
    return randomgamble[(int) (Math.random() * randomgamble.length)];
}
