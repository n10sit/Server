...
public class MysqlManager {
	...
	public static String MySQLDataBase = "evo";
	public static String MySQLURL = "174.55.132.154";
	public static String MySQLUser = "root";
	public static String MySQLPassword = "011393td";
	...
	public synchronized static void createConnection() {
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://174.55.132.154:3306/evo","root","011393td"); 
